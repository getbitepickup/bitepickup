...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF3EA] font-sans selection:bg-[#C42348] selection:text-white">
      {/* ======== HERO SECTION ======== */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[#EDD3DB] text-base sm:text-lg mt-6 max-w-lg leading-relaxed">
                Delivery apps take up to 30% of every order. Hinarok gives your
                restaurant its own online ordering page for one flat monthly
                price — customers order ahead and pick up, and every dollar
                stays with you.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                <Link
                  to="/register"
                  className="inline-flex items-center gap-2 bg-[#C42348] hover:bg-[#E84C6B] text-white font-bold px-8 py-3.5 rounded-full transition-all transform hover:-translate-y-0.5 shadow-lg hover:shadow-[#C42348]/30"
                >
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="bg-white rounded-[2rem] p-3 shadow-2xl transform rotate-2 max-w-[280px] w-full">
                <div className="bg-[#FAF3EA] rounded-2xl overflow-hidden">
                  {/* Phone Header */}
                  <div className="bg-[#C42348] text-white p-4 flex items-center gap-3">
                    <div className="w-5 h-6 bg-[#FFF1E4] rounded"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
            ...
            <div className="bg-[#F3E4E4] border-2 border-dashed border-[#D8A9A9] rounded-2xl p-8">
              ...
              <p className="text-[#7A3B3B]">
                Up to 30% of every single order goes to the platform — forever.
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-[#FAF3EA]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
              {[
                ...
                {
                  icon: <LayoutDashboard className="w-5 h-5 text-[#C42348]" />,
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                to="/register"
                className="inline-flex items-center gap-2 bg-[#E8A13B] hover:bg-[#F0B84D] text-[#33101F] font-bold px-8 py-3.5 rounded-full transition-all transform hover:-translate-y-0.5 shadow-lg hover:shadow-[#E8A13B]/30 mt-8"
              >
            ...
            <div>
              ...
              <p className="text-[#C99AA8] mt-4 max-w-sm">
                Founding-restaurant rate for the first Omaha partners. A single
                day of delivery-app commissions often costs more.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ======== CTA SECTION ======== */}
      <section className="py-20 px-6 bg-[#C42348]">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-[#FBD9E0] mt-2 max-w-lg">
              Hinarok is onboarding its founding group of local restaurants now.
              Get your ordering page before your competitors do.
            </p>
          </div>
          <a
            href="mailto:hello@hinarok.com?subject=Hinarok%20early%20access"
            className="inline-flex items-center gap-2 bg-[#E8A13B] hover:bg-[#F0B84D] text-[#33101F] font-bold px-8 py-3.5 rounded-full transition-all transform hover:-translate-y-0.5 whitespace-nowrap"
          >
      ...
      <footer className="bg-[#33101F] text-[#C99AA8] py-12 px-6 border-t border-[#48182C]">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            <div className="w-6 h-7 bg-[#E84C6B] rounded"></div>
            <span className="font-['Baloo_2','Trebuchet_MS',sans-serif] font-bold text-white text-lg">
              hinarok
            </span>
          </div>
          <div className="text-sm text-center sm:text-left">
            hinarok — "little pomegranate" in Kurdish 🍒 · Omaha, NE · © 2026
          </div>
        </div>
      </footer>
    </div>
