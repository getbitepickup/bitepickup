          ...
          <div className="bg-white border border-[#E7C7CF] rounded-2xl w-full max-w-md overflow-hidden shadow-2xl my-8">
            ...
            {createSuccess ? (
              ...
              >
                ...
                {/* ✅ REMOVED: Image upload buttons - Only URL inputs remain */}
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-[#33101F] mb-1 font-bold font-['Inter','Segoe UI',system-ui,sans-serif]">
                      Logo (URL)
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-[#E7C7CF] focus:border-[#C42348] rounded-xl focus:outline-none font-['Inter','Segoe UI',system-ui,sans-serif] text-xs"
